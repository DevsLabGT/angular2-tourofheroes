...
var hero_search_sevice_1 = require("./hero-search.sevice");
var HeroSearchComponent = (function () {
    ...
    HeroSearchComponent.prototype.gotoDetail = function (hero) {
        this.router.navigate(['/detalle', hero.id]);
    };
...
HeroSearchComponent = __decorate([
    core_1.Component({
        ...
        providers: [hero_search_sevice_1.HeroSearchService]
    }),
    __metadata("design:paramtypes", [hero_search_sevice_1.HeroSearchService,
        router_1.Router])
], HeroSearchComponent);
